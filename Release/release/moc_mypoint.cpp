...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myPoint_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_myPoint_t qt_meta_stringdata_myPoint = {
    {
QT_MOC_LITERAL(0, 0, 7) // "myPoint"
...
QT_INIT_METAOBJECT const QMetaObject myPoint::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_myPoint.data,
    qt_meta_data_myPoint,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *myPoint::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_myPoint.stringdata0))
